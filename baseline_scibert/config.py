...
OUTPUT_DIR = os.environ.get('SCIBERT_OUTPUT_DIR', os.path.join(BASE_DIR, 'output'))
...
# 模型配置
MODEL_NAME = os.environ.get('SCIBERT_MODEL_NAME', "allenai/scibert_scivocab_cased")
...
# 随机种子
SEED = int(os.environ.get('SCIBERT_SEED', 42))
